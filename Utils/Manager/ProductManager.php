...
class ProductManager extends DefaultManager
{
    ...
    public function getProductWithFormattedKeywords($keywords)
    {
        ...
        $terms = explode(' ', $keywords); $brand_name = null;
    ...
    {
        $joined_terms = implode(' ', array_keys($keywords)); $result = array($joined_terms => array());
        ...
        $heavy_weighting = array(); $old_value = null;
        foreach($weighting as $key => $value) {
            if ( is_null($old_value) ) {
                $old_value = $value; $heavy_weighting[$key] = $value;
            } elseif ( $value > $old_value ) {
                $old_value = $value; $heavy_weighting = array($key => $value);
            } elseif ( $value == $old_value ) {
    ...
    {
        $terms = explode(' ', strtolower($string)); $weight = null;
    ...
    {
        $terms = explode(' ', strtolower($string)); $capacity = null;
